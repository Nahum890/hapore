...
const messages = {
  'gn-jopara': {
    ...
    'language.label': 'Ñe’ẽ / Idioma', 'language.jopara': 'Jopara', 'language.spanish': 'Español',
    ...
    'pdf.joparaNote': 'Contenido en Jopara.',
    ...
    'nav.inicio': 'Ñepyrũ', 'nav.simulador': 'Ñaha’ã', 'nav.tarjetas': 'Jahecha jey', 'nav.chats': 'Eporandu', 'nav.aula': 'Aula', 'nav.mensajes': 'Ñomongeta', 'nav.label': 'Umi sección',
    ...
    'section.aula.title': 'Nde clase', 'section.aula.description': 'Ehai pe código ome’ẽva ndéve nde mbo’ehára ha ehecha umi material.',
    'section.mensajes.title': 'Ñomongeta nde clase ndive', 'section.mensajes.description': 'Emondo mensaje nde mbo’ehára ha nde irũnguérape, térã ehai chat grupal-pe.',
    'section.aulaTeacher.title': 'Embosako’i nde clase', 'section.aulaTeacher.description': 'Eiporavo temas, ejapo ejercicio térã embosako’i nde clase diapositiva reheve eproyecta hag̃ua.',
  ...
  es: {
    ...
    'language.label': 'Idioma', 'language.jopara': 'Jopara', 'language.spanish': 'Español',
    ...
    'nav.inicio': 'Inicio', 'nav.simulador': 'Practicar', 'nav.tarjetas': 'Repasar', 'nav.chats': 'Tutor', 'nav.aula': 'Aula', 'nav.mensajes': 'Mensajes', 'nav.label': 'Secciones principales',
    ...
    'section.aula.title': 'Tu clase', 'section.aula.description': 'Ingresá el código que te dio tu docente para ver los materiales.',
    'section.mensajes.title': 'Mensajes de tu clase', 'section.mensajes.description': 'Escribile a tu docente o a tus compañeros, o usá el chat grupal de la clase.',
    'section.aulaTeacher.title': 'Prepará tu aula', 'section.aulaTeacher.description': 'Compartí un código, creá ejercicios o prepará clases con diapositivas para proyectar.',
