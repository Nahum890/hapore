...
function ThermoScene({ exercise, phase }) {
  ...
  return <svg className={'concept-svg thermo-scene ' + (phase !== 'idle' ? 'is-active' : '')} viewBox="0 0 600 230" aria-hidden="true">
    ...
    {mixed ? <>
      ...
      <path d="M380 83 L488 83 L475 182 L393 182Z" fill="#dfdcd0" stroke="#759789" strokeWidth="3" /><text x="405" y="121" fill="#245246" fontSize="24" fontWeight="800">{final.toFixed(0)} °C</text><text x="398" y="150" fill="#245246" fontSize="13">equilibrio</text>
    </> : <>
      ...
      <text x="337" y="42" fill="#744927" fontSize="15">{initial} °C</text><text x="422" y="109" fill="#9d502d" fontSize="17" fontWeight="700">→ {final.toFixed(0)} °C</text>
...
function OpticsScene({ exercise, phase }) {
  ...
  return <svg className={'concept-svg optics-scene ' + (phase !== 'idle' ? 'is-active' : '')} viewBox="0 0 600 230" aria-hidden="true">
    ...
    {kind === 'espejo-plano' ? <>
      <circle cx="150" cy="110" r="22" fill="#efbc67" /><path d="M150 133 V179 M129 151 H171" stroke="#315c6b" strokeWidth="5" /><circle cx="456" cy="110" r="22" fill="#efbc67" opacity=".5" /><path d="M456 133 V179 M435 151 H477" stroke="#315c6b" strokeWidth="5" opacity=".5" />
      <path d="M150 204 H300 M308 204 H456" stroke="#315c6b" strokeWidth="2" strokeDasharray="7 5" /><text x="181" y="220" fill="#315c6b" fontSize="14">{values.distanciaObjeto} cm</text><text x="349" y="220" fill="#315c6b" fontSize="14">{values.distanciaObjeto} cm</text>
      ...
      <path d="M70 117 H523" stroke="#8baab8" strokeWidth="2" strokeDasharray="7 6" /><path className="optics-ray" d={`M${303 - dx} ${117 - dy} L303 117 L${303 - dx} ${117 + dy}`} fill="none" stroke="#e39a35" strokeWidth="5" strokeLinejoin="round" />
